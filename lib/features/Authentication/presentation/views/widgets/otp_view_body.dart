...
class OtpViewBody extends StatefulWidget {
  ...
  const OtpViewBody({super.key, required this.registerationId});
    ...
    return BlocConsumer<RegisterCubit, RegisterState>(
      ...
      if (state is ValidateOTPSuccessState) {
        ...
        if (state.resultCode == -3) {
          RegisterCubit.get(context).otpTimer?.cancel();
                        ...
                        child: Column(
                          children: [
                            Directionality(
                              ...
                              child: Pinput(
                                ...
                                onCompleted: (value) async {
                                  FocusNode().unfocus();
                                  registerCubit.completeRegistration(
                                    registerationId: widget.registerationId,
                                    otp: otpController.text,
                                  );
                                },
                                onChanged: (value) {
                                  registerCubit.onChangeOTPButtonDisable(value);
                                },
                            ...
                            isLoading == true
                                ...
                                : CustomButton(
                                    isDisabled:
                                        registerCubit.isOTPButtonDisabled,
                                    ...
                                    itemCallBack: state is OTPTimerState &&
                                        ...
                                        ? () {
                                            registerCubit.resendOtp(
                                                widget.registerationId);
                                          }
                                        : () {},
                                    text: buttonText!,
                                    isDisabled:
                                        registerCubit.isResendOTPButtonDisabled,
                                  ),
                          ],
                        ),
                      ),
