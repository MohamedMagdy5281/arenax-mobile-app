...
// import 'package:arenax_mobile_app/client/api.dart' as api_client;

// Future<AddAttachmentResponse?> uploadAttachment(File imageFile) async {
//   try {
//     // Open a byteStream
...
//     // String to URI
//     var uri = Uri.parse(
//         "https://befluent.trust2s.com/api/Attachment/create-attachment");
...
//           AddAttachmentResponse.fromJson(decodedJson).id;
//       return AddAttachmentResponse.fromJson(decodedJson);
//     }
//   } catch (e) {
//     // Handle exceptions
//     if (kDebugMode) {
