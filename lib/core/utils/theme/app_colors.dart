...
class AppColors extends ThemeExtension<AppColors> {
  ...
  final Color kUserNameShortcutBGColor;

  final Color kUserNameShortcutTextColor;
  ...
  static const dark = AppColors(
      ...
      kUserNameShortcutBGColor: Color(0XFFA87EFF),
      kUserNameShortcutTextColor: Color(0XFF280A5E));
  ...
  AppColors copyWith(
      ...
      Color? kUserNameShortcutBGColor,
      Color? kUserNameShortcutTextColor}) {
    return AppColors(
        ...
        kUserNameShortcutBGColor:
            kUserNameShortcutBGColor ?? this.kUserNameShortcutBGColor,
        kUserNameShortcutTextColor:
            kUserNameShortcutTextColor ?? this.kUserNameShortcutTextColor);
  }
  ...
  AppColors lerp(ThemeExtension<AppColors>? other, double t) {
    ...
    return AppColors(
      ...
      kUserNameShortcutBGColor: Color.lerp(
        kUserNameShortcutBGColor,
        other.kUserNameShortcutBGColor,
        t,
      )!,
      kUserNameShortcutTextColor: Color.lerp(
        kUserNameShortcutTextColor,
        other.kUserNameShortcutTextColor,
        t,
      )!,
    );
  }
